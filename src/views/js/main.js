...
- adjusted some length values in for loops into variables(items.length => itemsLength = items.length)
- see inline comments for more adjustments
...
function updatePositions() {
    ...
    for (var i = 0, len = itemsLength; i < len; i++) {
